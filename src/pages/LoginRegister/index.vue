  ...
  <div class="login-wrap" v-loading="loading" :element-loading-text="loadingtext"
    ...
    <div :class="{ 'right-panel-active': flag }" class="container">
      ...
      <div class="container_form container--signin">
        <form class="form">
          <h2 class="form_title" v-html="isAdmin ? '管理员登录' : '用户登录'"></h2>
          ...
          <input type="tel" v-if="!isAdmin" placeholder="User" class="input" v-model="loginMsg.userName" />
          <input type="tel" v-else placeholder="User" class="input" v-model="loginMsg.userName" />
