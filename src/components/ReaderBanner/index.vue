<template>
  <div class="main">
    ...
    <el-menu default-active="1" class="el-menu-vertical-demo" :collapse="isCollapse" @open="handleOpen"
      @close="handleClose" active-text-color="#ffd04b">
      ...
      <el-menu-item index="6" @click="$router.push('/home/useradvice')">
        <i class="el-icon-message-solid"></i>
        <span slot="title">用户反馈</span>
      </el-menu-item>
      <el-menu-item index="7" @click="$router.push('/home/comment')">
        <i class="el-icon-s-comment"></i>
        <span slot="title">书籍评论</span>
      </el-menu-item>
      <el-menu-item index="8" @click="$router.push('/home/BookAdd')">
        <i class="el-icon-document-copy"></i>
        <span slot="title">添加图书</span>
      </el-menu-item>
      <el-menu-item index="9" @click="$router.push('/home/schedule')">
        <i class="el-icon-document-copy"></i>
